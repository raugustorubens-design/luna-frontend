  ...
  return (
    <div className="rounded-lg border border-white/10 bg-white/[0.03] p-3">
      <div className="mb-2 flex items-center justify-between gap-2">
        <h3 className="text-sm font-semibold text-slate-100">{RISK_CATEGORY_LABELS[finding.categoria]}</h3>
        ...
        <div className="mt-3 flex flex-col gap-3 border-t border-white/10 pt-3">
          <label className="flex flex-col gap-1 text-xs text-slate-400">
            ...
            <input
              ...
              className="rounded border border-white/15 bg-transparent px-2 py-1.5 text-sm text-slate-100 [color-scheme:dark]"
          ...
          <div className="flex flex-col gap-1.5 text-xs text-slate-400">
            ...
            <div className="flex flex-wrap gap-2">
              {(finding.fotos ?? []).map((photo, index) => (
                <div key={index} className="relative h-16 w-16 overflow-hidden rounded border border-white/15">
              ...
              <button
                ...
                className="flex h-16 w-16 items-center justify-center rounded border border-dashed border-white/25 text-[10px] text-slate-400 hover:border-cyan-400 hover:text-cyan-300 disabled:opacity-50"
              >
                {compressing ? "…" : "+ Foto"}
              </button>
            </div>
          ...
          <label className="flex flex-col gap-1 text-xs text-slate-400">
            ...
            <textarea
              ...
              rows={3}
              className="rounded border border-white/15 bg-transparent px-2 py-1.5 text-sm text-slate-100"
